    ...
    if err == nil {
      ...
      if err == nil {
        for _, attachment := range email.Attachments {
          db.StoreAttachment(email.MailboxID, messageId, attachment.AttachmentFileName, attachment.AttachmentContentType, attachment.AttachmentTransferEncoding, attachment.AttachmentBody)
        }
      }
    }
  }
